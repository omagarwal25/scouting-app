...
const _0a4b82 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _33be66, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _0a4b82, lazy: true, method: undefined },
  { route: '/**', handler: _0a4b82, lazy: true, method: undefined }
];
